...
from neural_network import PolicyNetwork, ValueNetwork, PredictiveNetwork
...
class DataProcessor:
    ...
    def update_transition_buffer(self, result):
        """
    ...
    def generate_trajectory_reward_batch(self, cur_state, pNet: PolicyNetwork, vNet: ValueNetwork,
        ...
        for step in range(trajectory_len):
            ...
            next_state_tensor = ensemble_dNet.get_random_next_state_and_reward(states_batch_tensor,
    ...
    def generate_policy_training_data(self, pNet: PolicyNetwork, vNet: ValueNetwork, ensemble_dNet: Ensembler,
        ...
        # maintain fixed size
        self.update_transition_buffer(result)
