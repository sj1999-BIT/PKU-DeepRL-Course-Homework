...
class ImprovedQAgentWithEpilson(nn.Module):

    def __init__(self, load_path=None, epsilon=1.0):
        # can take in different state inputs
        super(ImprovedQAgentWithEpilson, self).__init__()
...
class QAgentWithEpilsonAndMoreDepth(nn.Module):

    def __init__(self, load_path=None, epsilon=1.0):
        # can take in different state inputs
        super(QAgentWithEpilsonAndMoreDepth, self).__init__()
