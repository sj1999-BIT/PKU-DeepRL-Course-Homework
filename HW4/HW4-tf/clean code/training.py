...
def generate_mix_NN_inputs_for_full_episode(episode_dict, agent: AgentNetwork):
    """
...
def get_TD_error(episode_dict, agent: AgentNetwork, mixNet: MixNetwork, discount_factor=0.99):
    """
    ...
    mixNet_inputs = generate_mix_NN_inputs_for_full_episode(episode_dict, agent)
