...
class TrajectoryProcessor:
    ...
    def generate_data(self, envs: [gym.Env], policyNet: PolicyNetwork, valueNet: ValueNetwork, trajectory_length=1000):
        """
        ...
        Args:
            ...
            trajectory_length: length of the trajectory we are collecting
        ...
        for trajectory_step in tqdm(range(trajectory_length), desc="Collecting replay experience"):  # Fixed step limit
